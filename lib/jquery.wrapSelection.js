...
//		selRange.commonAncestorContainer	= commonAncestorContainer;
	...
	$.fn.wrapSelection = function(options) {
		...
		var defaults = {
			...
			regexWordCharacterBasic: new RegExp(/^[A-Za-z0-9\u00C4\u00E4\u00DC\u00FC\u00D6\u00F6'\u00DF\-]$/),// fitToWord Var
			regexWordCharacterFull: new RegExp(/^[A-Za-z0-9\u00C4\u00E4\u00DC\u00FC\u00D6\u00F6\u00DF':,\-]$/),// fitToWord Var
		...
		if (range.startContainer && range.endContainer){
			...
			SplitText();
			var myCount = doWrap();
			if (myCount) range.ClearAllWSRanges();
